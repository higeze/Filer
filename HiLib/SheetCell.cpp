...
//	//	g_hDlgModeless = pDlg->Create(m_pGrid->GetWndPtr()->m_hWnd);
...
//{
//	CSheet::OnPaint(PaintEvent(m_pGrid->GetWndPtr()));
//}
//
////std::shared_ptr<CDC> CSheetCell::GetClientDCPtr()const
////{
////	return m_pGrid->GetClientDCPtr();
////}
//CGridView* CSheetCell::GetGridPtr()
//{
//	return m_pGrid->GetGridPtr();
//}
////
...
//{
//	return m_pGrid->GetParentColumnPtr(this);
//}
//
