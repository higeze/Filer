...
class CRowDragger :public IMouseObserver
{
private:
	typedef int size_type;
	typedef int coordinates_type;
...
private:
	...
	size_type m_dragToIndex;
public:
	CRowDragger() :m_dragFromIndex(INDEX_INVALID), m_dragToIndex(INDEX_INVALID) {}
	virtual ~CRowDragger() {}
	size_type GetDragToAllIndex() { return m_dragToIndex; }
	size_type GetDragFromAllIndex() { return m_dragFromIndex; }
...
*/
class CSheetCellDragger:public CColumnDragger
{
public:
    /*! Constructor*/
	CSheetCellDragger():CColumnDragger(){}
