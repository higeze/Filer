...
class CD2DWDialog2 : public CD2DWDialog
{
public:
	const FLOAT kSizeWidth = 5.f;
public:
...
protected:
	std::unique_ptr<CDialogStateMachine> m_pDialogMachine;
	std::shared_ptr<CDockPanel> m_spDockPanel;
	std::shared_ptr<CTextBlock> m_spTitleTextBlock;

	std::optional<CPointF> m_startPoint;

public:
	CD2DWDialog2(CD2DWControl* pParentControl = nullptr);
	virtual ~CD2DWDialog2();
