...
public:
	...
	virtual void RowDrag_LButtonEndDrag(const LButtonEndDragEvent& e);
	...
	virtual void ColDrag_LButtonEndDrag(const LButtonEndDragEvent& e);
	...
	virtual void ItemDrag_LButtonEndDrag(const LButtonEndDragEvent& e);
