...
class D2DControl : public D2DCaptureObject
{
	public :
		...
		virtual LRESULT WndProc(d2dw::CDirect2DWrite&, UINT message, WPARAM wParam, LPARAM lParam) = 0;
...
class D2DControls : public D2DControl
{
	public :
		...
		virtual LRESULT WndProc(d2dw::CDirect2DWrite& d, UINT message, WPARAM wParam, LPARAM lParam);
...
class D2DTextbox : public D2DControl, public IBridgeTSFInterface
{
	...
	public :
		virtual LRESULT WndProc(d2dw::CDirect2DWrite& parent, UINT message, WPARAM wParam, LPARAM lParam);
