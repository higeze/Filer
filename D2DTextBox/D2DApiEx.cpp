...
//	if (HR(cxt.m_pDirect->GetDWriteFactory()->CreateTextLayout(str,len, cxt.text,sz.width, sz.height, &tl )))
//	{
//		tl->GetMetrics(&tm);
//
//		FRectF rcX(rc);
...
//		}
//
//		cxt.m_pDirect->GetDWriteFactory()->DrawText( str, len, cxt.text, rcX, clr, D2D1_DRAW_TEXT_OPTIONS::D2D1_DRAW_TEXT_OPTIONS_CLIP );
//	}
//}
//
