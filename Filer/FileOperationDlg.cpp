	...
	:CSimpleFileOperationDlgBase(pParentControl, srcIDL, srcChildIDLs), m_destIDL(destIDL)
{
	...
	m_spFilerControl = std::make_unique<CFileOperationGridView<std::tuple<std::shared_ptr<CShellFile>, RenameInfo>>>(
		...
		arg<"columns"_s>() = std::vector<std::shared_ptr<CColumn>>{
			...
			std::make_shared<CFilePathNameColumn<std::tuple<std::shared_ptr<CShellFile>, RenameInfo>>>(nullptr),
			std::make_shared<CFilePathExtColumn<std::tuple<std::shared_ptr<CShellFile>, RenameInfo>>>(nullptr),
			std::make_shared<CFilePathRenameColumn<std::tuple<std::shared_ptr<CShellFile>, RenameInfo>>>(nullptr),
			std::make_shared<CFileReextColumn<std::tuple<std::shared_ptr<CShellFile>, RenameInfo>>>(nullptr),
	...
	:CSimpleFileOperationDlgBase(pParentControl, srcIDL, srcChildIDLs)
{
	...
	m_spFilerControl = std::make_unique<CFileOperationGridView<std::shared_ptr<CShellFile>>>(
		...
		arg<"columns"_s>() = std::vector<std::shared_ptr<CColumn>>{
			std::make_shared<CRowIndexColumn>(nullptr),
			std::make_shared<CFilePathNameColumn<std::shared_ptr<CShellFile>>>(nullptr),
			std::make_shared<CFilePathExtColumn<std::shared_ptr<CShellFile>>>(nullptr),
